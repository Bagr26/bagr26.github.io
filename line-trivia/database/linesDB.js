  ...
  tramLinesDay: [
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Korunovační", "Tusarova"], neg: ["Dělnická"] }],
      stations: [
        "Sídliště Petřiny",
        "Petřiny",
        "Větrník",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Novoměstská radnice"], neg: ["Moráň"] }],
      stations: [
        "Sídliště Petřiny",
        "Petřiny",
        "Větrník",
    ...
    },
    {
      ...
      routeExceptions: [
        ...
        { pos: ["Novoměstská radnice", "Levského"], neg: ["Březiněveská", "Divadlo pod Palmovkou", "Moráň"] },
      ],
      stations: [
        "Březiněvská",
        "Kobylisy",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Novoměstská Radnice"], neg: ["Březiněveská", "Nábřeží Kapitána Jaroše"] }],
      stations: [
        "Březiněvská",
        "Kobylisy",
        "Ke Stírce",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: [], neg: ["Vinice"] }],
      stations: [
        "Radlická",
        "Škola Radlice",
        "Laurová",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Korunovační"], neg: [] }],
      stations: [
        "Nádraží Podbaba",
        "Zelená",
        "Lotyšská",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Moráň", "Mezi Hřbitovy", "Divadlo pod Palmovkou", "Třebenická"], neg: [] }],
      stations: [
        "Sídliště Řepy",
        "Blatiny",
        "Slánská",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: [], neg: ["Mezi Hřbitovy"] }],
      stations: [
        "Spojovací",
        "Kněžská luka",
        "Chmelnice",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["U Průhonu"], neg: ["Tusarova", "Korunovační"] }],
      stations: [
        "Výstaviště",
        "Nádraží Holešovice",
        "U Průhonu",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Dělnická", "Novoměstská radnice"], neg: ["Tusarova", "Moráň"] }],
      stations: [
        "Palmovka",
        "Libeňský most",
        "Maniny",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Levského"], neg: ["Nábřeží Kapitána Jaroše"] }],
      stations: [
        "Vozovna Kobylisy",
        "Líbeznická",
        "Březiněvská",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Otakarova", "Mezi Hřbitovy"], neg: ["Vinice"] }],
      stations: [
        "Pankrác",
        "Kotorská",
        "Pražského povstání",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Pohořelec", "Novoměstská radnice"], neg: ["Hládkov"] }],
      stations: [
        "Královka",
        "Malovanka",
        "Hládkov",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Novoměstská radnice"], neg: ["Březiněveská", "Divadlo pod Palmovkou", "Moráň", "Otakarova"] }],
      stations: [
        "Březiněvská",
        "Kobylisy",
        "Ke Stírce",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ pos: ["Korunovační", "Vinice"], neg: ["Mezi Hřbitovy"] }],
      stations: [
        "Dědina",
        "Sídliště Na Dědině",
        "Vlastina",
