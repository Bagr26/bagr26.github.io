...
export const linesDB = {
  ...
  tramLinesDay: [
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ both: [], pos: ["Dělnická", "Novoměstská radnice"], neg: ["Palmovka (B)", "U Průhonu", "Nábřeží Kapitána Jaroše"] }],
      stations: [
        "Vysočanská",
        "Nádraží Vysočany",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ both: [], pos: ["Depo Hostivař (ul. Černokostelecká)"], neg: ["Vinice"] }],
      stations: [
        "Radlická",
        "Škola Radlice",
        "Laurová",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [{ both: [], pos: ["Korunovační", "Palmovka (ul. Zenklova)"], neg: ["Nábřeží Kapitána Jaroše"] }],
      stations: [
        "Nádraží Podbaba",
        "Zelená",
        "Lotyšská",
    ...
    },
    {
      ...
      routes: [[0, 1]],
      routeExceptions: [
        { both: [], pos: ["Palmovka (ul. Na Žertvách)", "Dělnická", "Novoměstská radnice"], neg: ["Palmovka (B)", "Tusarova", "Moráň"] },
      ],
      stations: [
        "Palmovka (ul. Na Žertvách)",
        "Palmovka (B)",
